...
- 脚本每天执行 3 次：北京时间 **00:10 / 08:10 / 10:10**，各自紧跟平台的赠送时间
  - `00:10`：接住 agentrouter 每天 00:05 的到账
  - `08:10`：接住 anyrouter 每天 08:05 之后登录才给的赠送
  - `10:10`：anyrouter 的补跑 —— 它每天只有「08:05 之后登录」这一个窗口，08:10 失败就没机会了
- 每天 3 次而不是每 6 小时，是为了减少重复浏览器登录次数，降低被平台限流的风险
- GitHub 的 schedule 常有延迟（实测落地间隔 5 小时上下，偶尔整次丢弃），所以实际执行时间会晚一些
- 你也可以随时手动触发签到
